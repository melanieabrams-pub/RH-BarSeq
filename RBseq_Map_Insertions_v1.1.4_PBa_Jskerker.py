...
def main(argv):
    ...
    for pool in mappedFilesPerPool:
        ...
        offByOneFileHandle = open(outPutFileName+"_offByOne", 'w', encoding='UTF-8')
        ...
        ambFileHandle = open(outPutFileName+"_ambiguous", 'w', encoding='UTF-8')
        multiFileHandle = open(outPutFileName+"_multiLocus", 'w', encoding='UTF-8')
        ...
        outPutFileHandle = open(outPutFileName+"_insertReadsOnly", 'w', encoding='UTF-8')
        ...
        if options.filterNeighborhood > 0 and len(barcode_primary_location) > 0:
            ...
            outPutFileHandle = open(outPutFileName, 'w', encoding='UTF-8')
            obtFileHandle = open(outPutFileName+"_filteredLocal", 'w',encoding='UTF-8')
            barcodeSummary = "\t".join(["barcode","rcbarcode","nTot", "n", "scaffold", "strand", "pos","type","nMainLocation", "nInsert", "All genomic mappings", "All insert mappings"])
